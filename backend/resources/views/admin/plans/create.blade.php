    ...
    <form method="post" action="{{ route('admin.plans.store') }}">
        ...
        <div class="card card-primary">
            <div class="card-header">
                <h3 class="card-title">Novo plano</h3>
            </div>
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2 @error('measure') is-invalid @enderror" id="measure" name="measure" value="{{ old('measure') }}">
                ...
                <div class="form-group">
                    ...
                    <input name="qty" type="decimal" id="qty" class="form-control @error('qty') is-invalid @enderror" min="1" value="{{ old('qty') }}" />
                    @error('qty')
                ...
                <div class="form-group">
                    <div class="custom-control custom-switch">
                        <input type="checkbox" class="custom-control-input @error('is_better') is-invalid @enderror" id="is_better" name="is_better" @checked(old('is_better')) }}">
